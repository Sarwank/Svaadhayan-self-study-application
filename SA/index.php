...
<body>
      ...
      if(isset($_POST['btn_img']))
      {
        ...
        ?>
         ...
         <form action="index.php" method="post" class="form-control" enctype="multipart/form-data">
            ...
            <button type="button" id="redirectToPageButton"    class="btn btn-secondary">Back to home</button>
            </div>
        </form>
        ...
        <table class="table text-center">
            ...
            while($fetch = mysqli_fetch_assoc($result2))
            {
                ...
                <tr>
                    ...
                    <td><a href="./image/<?php echo $fetch['image'] ?>" width=100px alt=""><?php echo $fetch['image'] ?></a></td>
    ...
    var button = document.getElementById('redirectToPageButton');
